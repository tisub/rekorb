...
define("__CLASSNAME__", "\\LeMonde");

use com\anotherservice\util as cau;
use com\anotherservice\db as cad;

class LeMonde extends com\busit\Connector implements com\busit\Producer, com\busit\Consumer
{
	public function produce($out)
	{
		...
		switch( $out->key )
		{
			...
			break;
			case 'politic':
				$url = 'http://rss.lemonde.fr/c/205/f/3067/index.rss';
			break;
			case 'international':
				$url = 'http://rss.lemonde.fr/c/205/f/3052/index.rss';
			break;
			case 'economy':
				$url = 'http://rss.lemonde.fr/c/205/f/3055/index.rss';
			break;
			case 'sport':
				$url = 'http://rss.lemonde.fr/c/205/f/3058/index.rss';
			break;
			case 'societe':
				$url = 'http://rss.lemonde.fr/c/205/f/3054/index.rss';
			break;
			case 'science':
				$url = 'http://www.lemonde.fr/rss/tag/sciences.xml';
			break;
			case 'technology':
				$url = 'http://rss.lemonde.fr/c/205/f/3061/index.rss';
			break;
			case 'pixels':
				$url = 'http://rss.lemonde.fr/c/205/f/672609/index.rss';
			break;
			default:
				$url = 'http://rss.lemonde.fr/c/205/f/3050/index.rss';
		}
			...
			if( count($news) > 0 )
			{
				...
				{	
					...
					if( !$row['buffer_identifier'] )
					{
						...
						$content['date'] =  $n['date'];
						$content['author'] = 'Le Monde';
						$content['image'] = 'https://images.busit.com/connectors/18_100.png';
