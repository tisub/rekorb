...
define("__CLASSNAME__", "\\DailyStarLB");

use com\anotherservice\util as cau;
use com\anotherservice\db as cad;

class DailyStarLB extends com\busit\Connector implements com\busit\Producer, com\busit\Consumer
{
	public function produce($out)
	{
		...
		switch( $out->key )
		{
			...
			break;
			case 'middleeast':
				$url = 'http://www.dailystar.com.lb/RSS.aspx?id=102';
			break;
			case 'national':
				$url = 'http://www.dailystar.com.lb/RSS.aspx?id=1';
			break;
			case 'news':
			...
			if( count($news) > 0 )
			{
				...
				{	
					...
					if( !$row['buffer_identifier'] )
					{
						...
						$content['date'] =  $n['date'];
						$content['author'] = 'The Daily Star (Lebanon)';
						$content['image'] = 'https://images.busit.com/connectors/238_100.png';
