...
define("__CLASSNAME__", "\\Maddyness");

use com\anotherservice\util as cau;
use com\anotherservice\db as cad;

class Maddyness extends com\busit\Connector implements com\busit\Producer, com\busit\Consumer
{
	public function produce($out)
	{
		...
		$url = 'http://www.maddyness.com/feed/';
			...
			if( count($news) > 0 )
			{
				...
				{	
					...
					if( !$row['buffer_identifier'] )
					{
						...
						$content['date'] =  $n['date'];
						$content['author'] = 'Maddyness';
						$content['image'] = 'https://images.busit.com/connectors/326_100.png';
