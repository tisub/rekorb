...
define("__CLASSNAME__", "\\JerusalemPostEn");

use com\anotherservice\util as cau;
use com\anotherservice\db as cad;

class JerusalemPostEn extends com\busit\Connector implements com\busit\Producer, com\busit\Consumer
{
	public function produce($out)
	{
		...
		{
			case 'defense':
				$url = 'http://www.jpost.com/Rss/RssFeedsDefense.aspx';
			break;
			case 'diplomacy':
				$url = 'http://www.jpost.com/Rss/RssFeedsDiplomacyAndPolitics.aspx';
			break;
			case 'international':
				$url = 'http://www.jpost.com/Rss/RssFeedsInternationalNews.aspx';
			break;
			case 'national':
				$url = 'http://www.jpost.com/Rss/RssFeedsIsraelNews.aspx';
			break;
			case 'news':
			...
			if( count($news) > 0 )
			{
				...
				{	
					...
					if( !$row['buffer_identifier'] )
					{
						...
						$content['date'] =  $n['date'];
						$content['author'] = 'The Jerusalem Post (English)';
						$content['image'] = 'https://images.busit.com/connectors/237_100.png';
