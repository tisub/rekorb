...
define("__CLASSNAME__", "\\SlateFr");

use com\anotherservice\util as cau;
use com\anotherservice\db as cad;

class SlateFr extends com\busit\Connector implements com\busit\Producer, com\busit\Consumer
{
			...
			if( count($news) > 0 )
			{
				...
				{	
					...
					if( !$row['buffer_identifier'] )
					{
						...
						$content['date'] =  $n['date'];
						$content['author'] = 'Slate.fr';
						$content['image'] = 'https://images.busit.com/connectors/125_100.png';
