...
define("__CLASSNAME__", "\\CNN");

use com\anotherservice\util as cau;
use com\anotherservice\db as cad;

class CNN extends com\busit\Connector implements com\busit\Producer, com\busit\Consumer
{
			...
			if( count($news) > 0 )
			{
				...
				{	
					...
					{						
						...
						$content['date'] =  $n['date'];
						$content['author'] = 'CNN';
						$content['image'] = 'https://images.busit.com/connectors/28_100.png';
