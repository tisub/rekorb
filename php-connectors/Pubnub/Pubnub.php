...
define("__CLASSNAME__", "\\BusPubnub");

use com\busit as cb;
use com\anotherservice\util as cau;
use \Exception;

class BusPubnub extends com\busit\Connector implements com\busit\Consumer
{
	private $pubnub;
	...
	public function consume($message, $in)
	{
		...
		$this->pubnub = new Pubnub($this->config('publishkey'), $this->config('subscribekey'));
		$this->pubnub->publish($in->value, $data);
	}
